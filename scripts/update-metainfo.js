#!/usr/bin/env node
// Prepends a <release> entry to assets/com.factorpos.desktop.metainfo.xml at release
...
const META_FILE = path.join(ROOT, 'assets/com.factorpos.desktop.metainfo.xml');
